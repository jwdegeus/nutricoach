        ...
        <div className="grid min-h-full grid-rows-[1fr_auto_1fr] justify-items-center p-8 sm:grid-rows-[1fr_auto_3fr] sm:p-4">
          <Headless.DialogPanel
            ...
            className={clsx(
              className,
              sizes[size],
              'row-start-2 w-full rounded-2xl bg-white p-8 shadow-lg ring-1 ring-zinc-950/10 sm:rounded-2xl sm:p-6 dark:bg-zinc-900 dark:ring-white/10 [@media(forced-colors:active)]:outline',
...
export function AlertActions({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        'mt-6 flex flex-col-reverse items-center justify-end gap-3 sm:mt-4 sm:flex-row [&>*]:w-full sm:[&>*]:w-auto',
      )}
    />
  );
}
