-- Migration: Fix finalize_recipe_import to correctly save savedImageUrl
-- Created: 2026-01-31
-- Description: Ensure savedImageUrl from source_image_meta is correctly saved to custom_meals.source_image_url
