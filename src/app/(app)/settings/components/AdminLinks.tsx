...
export function AdminLinks({ hideSectionHeading }: AdminLinksProps = {}) {
  return (
    <div
      className={
        hideSectionHeading
          ? undefined
          : 'rounded-lg bg-white p-6 shadow-xs ring-1 ring-zinc-950/5 dark:bg-zinc-900 dark:ring-white/10'
      }
    >
      {!hideSectionHeading && (
        <div className="mb-6">
