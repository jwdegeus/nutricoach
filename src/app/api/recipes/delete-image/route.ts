      ...
      return NextResponse.json(
        {
          ...
          error: {
            ...
            message: "Verwijderen van afbeeldingen voor Gemini recepten is nog niet geïmplementeerd",
          },
        },
        { status: 501 }
      );
    ...
    return NextResponse.json(
      {
        ...
        error: {
          code: "DELETE_ERROR",
          message: error instanceof Error ? error.message : "Onbekende fout bij verwijderen",
        },
      },
      { status: 500 }
    );
